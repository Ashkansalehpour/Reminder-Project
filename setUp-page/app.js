  ...
  let elapsedTime = 0;
  function startTimer() {
      const secondsInput = parseInt(document.getElementById('ss-rem').value) || 0;
      const minutesInput = parseInt(document.getElementById('mm-rem').value) || 0;
      const hoursInput = parseInt(document.getElementById('hh-rem').value) || 0;
      const timerPercentage = document.querySelector('.timer-percentage');
  
      totalMilliseconds = (hoursInput * 3600 + minutesInput * 60 + secondsInput) * 1000;
